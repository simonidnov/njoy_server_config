...
io.on('connection', function(socket){
    ...
    socket.on('njoy', function(datas){
        ...
        switch(datas.status){
            ...
            case 'success':
                video_player = Omx("http://10.3.141.1:3000/ressources/fx/gagne.mp4", "local", false, 1.0);
                video_player.volUp();
                video_player.play();
                ...
                break;
            case 'fail':
                video_player = Omx("http://10.3.141.1:3000/ressources/fx/perdu.mp4", "local", false, 1.0);
                video_player.volUp();
                video_player.play();
                video_player.on('close', function(){
                  //video_player.quit();
