/*
  TODO the canvas size doesn't reflect the device size !important NOTE : broadcast RATIO is 1920*1080
...
var receptor = {
    ...
    setChronos: function (time, type) {
        ...
        var chronos_tween = TweenMax.to($('.timelap .progress'), parseInt(time), {
            css: { width: "100%" }, ease: Linear.easeNone, onUpdate: function (e) {
